...
from qgate_sln_mlrun.ts import ts101, ts102, ts201, ts301, ts302, ts401, ts501, ts502, ts601, ts701
...
class QualityReport:
    ...
    TEST_SCENARIOS = [ts101.TS101, ts201.TS201, ts301.TS301, ts302.TS302, ts401.TS401, ts501.TS501, ts502.TS502]
