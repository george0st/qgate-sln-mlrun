...
from qgate_sln_mlrun.ts import ts101, ts102, ts201, ts202, ts203, ts204, ts205, ts301, ts302, ts303, ts304, ts401, ts501, ts502, ts701, ts801
...
class QualityReport:
    ...
    TEST_SCENARIOS = [ts101.TS101,
                      ts201.TS201, ts202.TS202, ts203.TS203, ts204.TS204, ts205.TS205,
    ...
    TEST_BOTH = ["TS101","TS102","TS201", "TS202", "TS203", "TS204", "TS205", "TS301", "TS302", "TS303", "TS304", "TS401"]
