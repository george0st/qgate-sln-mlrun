...
from qgate_sln_mlrun.ts import ts101, ts102, ts201, ts202, ts203, ts204, ts205, ts301, ts302, ts303, ts401, ts501, ts502, ts701, ts801
...
class QualityReport:
    ...
    TEST_BOTH = ["TS101","TS102","TS201", "TS202", "TS203", "TS204", "TS205", "TS301", "TS302", "TS303", "TS401"]
